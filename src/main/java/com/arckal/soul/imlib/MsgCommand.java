...
public class MsgCommand extends Command {
    ...
    public MsgCommand(String fromUserId,String toUserId,String message,long msgTime){
    ...
    public static Command parseFrom(byte[] bytes) {
            ...
            return new MsgCommand(fromUserId,toUserId,message,Long.parseLong(timeStr1));
    }
